    ...
    it('should extract Task invocation (backward compat)', () => {
      const line = {
        ...
        message: {
          role: 'assistant' as const,
          content: [
            { type: 'tool_use' as const, id: 'toolu_02', name: 'Task', input: { subagent_type: 'Explore' } },
          ],
        },
      };
      const results = extractInvocations(line);
    ...
    it('should extract Skill invocation', () => {
      const line = {
        ...
        message: {
          role: 'assistant' as const,
          content: [
            { type: 'tool_use' as const, id: 'toolu_03', name: 'Skill', input: { skill: 'gsd:plan-phase' } },
          ],
        },
      };
      const results = extractInvocations(line);
      ...
      const line = {
        ...
        message: {
          ...
          content: [
            ...
            { type: 'tool_use' as const, id: 'toolu_01', name: 'Agent', input: { subagent_type: 'Research' } },
            { type: 'tool_use' as const, id: 'toolu_02', name: 'mcp__sequential-thinking__sequentialthinking', input: {} },
          ],
        },
      };
      const results = extractInvocations(line);
    ...
    it('should skip Skill invocation without skill field', () => {
      const line = {
        ...
        message: {
          role: 'assistant' as const,
          content: [
            { type: 'tool_use' as const, id: 'toolu_06', name: 'Skill', input: {} },
          ],
        },
      };
      const results = extractInvocations(line);
    ...
    it('should propagate isSidechain from the line', () => {
      const line = {
        ...
        message: {
          role: 'assistant' as const,
          content: [
            { type: 'tool_use' as const, id: 'toolu_08', name: 'Agent', input: { subagent_type: 'Review' } },
          ],
        },
      };
      const results = extractInvocations(line);
    ...
    it('should default projectPath to empty string when cwd is missing', () => {
      const line = {
        ...
        message: {
          role: 'assistant' as const,
          content: [
            { type: 'tool_use' as const, id: 'toolu_09', name: 'Skill', input: { skill: 'test-skill' } },
          ],
        },
      };
      const results = extractInvocations(line);
    ...
    it('should skip Agent invocation without input at all', () => {
      const line = {
        ...
        message: {
          role: 'assistant' as const,
          content: [
            { type: 'tool_use' as const, id: 'toolu_10', name: 'Agent' },
          ],
        },
      };
      const results = extractInvocations(line);
    ...
    it('should ignore non-agent/skill/mcp tool_use blocks', () => {
      const line = {
        ...
        message: {
          role: 'assistant' as const,
          content: [
            { type: 'tool_use' as const, id: 'toolu_11', name: 'Read', input: { file_path: '/test' } },
