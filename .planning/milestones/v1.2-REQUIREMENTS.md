# Requirements Archive: v1.2 Full Release
...
|-------------|-------|-----------|--------|
| DIST-01 | Phase 1: Foundation & Scaffold | v1.0 | Validated |
| DIST-02 | Phase 1: Foundation & Scaffold | v1.0 | Validated |
| DIST-03 | Phase 1: Foundation & Scaffold | v1.0 | Validated |
| DIST-04 | Phase 1: Foundation & Scaffold | v1.0 | Validated |
| DIST-05 | Phase 1: Foundation & Scaffold | v1.0 | Validated |
| PARS-01 | Phase 2: JSONL Parser | v1.0 | Validated |
| PARS-02 | Phase 2: JSONL Parser | v1.0 | Validated |
| PARS-03 | Phase 2: JSONL Parser | v1.0 | Validated |
| PARS-04 | Phase 2: JSONL Parser | v1.0 | Validated |
| PARS-05 | Phase 2: JSONL Parser | v1.0 | Validated |
| PARS-06 | Phase 2: JSONL Parser | v1.0 | Validated |
| PARS-07 | Phase 2: JSONL Parser | v1.0 | Validated |
| SCAN-01 | Phase 3: Inventory Scanner | v1.0 | Validated |
| SCAN-02 | Phase 3: Inventory Scanner | v1.0 | Validated |
| SCAN-03 | Phase 3: Inventory Scanner | v1.0 | Validated |
| SCAN-04 | Phase 3: Inventory Scanner | v1.0 | Validated |
| SCAN-05 | Phase 3: Inventory Scanner | v1.0 | Validated |
| SCAN-06 | Phase 3: Inventory Scanner | v1.0 | Validated |
| SCAN-07 | Phase 3: Inventory Scanner | v1.0 | Validated |
| TOKN-01 | Phase 4: Token Cost Attribution | v1.0 | Validated |
| TOKN-02 | Phase 4: Token Cost Attribution | v1.0 | Validated |
| TOKN-03 | Phase 4: Token Cost Attribution | v1.0 | Validated |
| TOKN-04 | Phase 4: Token Cost Attribution | v1.0 | Validated |
| TOKN-05 | Phase 4: Token Cost Attribution | v1.0 | Validated |
| REPT-01 | Phase 5: Report & CLI Commands | v1.0 | Validated |
| REPT-02 | Phase 5: Report & CLI Commands | v1.0 | Validated |
| REPT-03 | Phase 5: Report & CLI Commands | v1.0 | Validated |
| REPT-04 | Phase 5: Report & CLI Commands | v1.0 | Validated |
| REPT-05 | Phase 5: Report & CLI Commands | v1.0 | Validated |
| REPT-06 | Phase 5: Report & CLI Commands | v1.0 | Validated |
| REPT-07 | Phase 5: Report & CLI Commands | v1.0 | Validated |
| OUTP-01 | Phase 6: Output Control & Polish | v1.0 | Validated |
| OUTP-02 | Phase 6: Output Control & Polish | v1.0 | Validated |
| OUTP-03 | Phase 6: Output Control & Polish | v1.0 | Validated |
| OUTP-04 | Phase 6: Output Control & Polish | v1.0 | Validated |
| OUTP-05 | Phase 6: Output Control & Polish | v1.0 | Validated |
| OUTP-06 | Phase 6: Output Control & Polish | v1.0 | Validated |
| OUTP-07 | Phase 6: Output Control & Polish | v1.0 | Validated |
| DRYR-01 | Phase 7: Dry-Run & Checkpoint | v1.1 | Validated |
| DRYR-02 | Phase 7: Dry-Run & Checkpoint | v1.1 | Validated |
| DRYR-03 | Phase 7: Dry-Run & Checkpoint | v1.1 | Validated |
| RMED-01 | Phase 8: Remediation Core | v1.2 | Validated |
| RMED-02 | Phase 8: Remediation Core | v1.2 | Validated |
| RMED-03 | Phase 8: Remediation Core | v1.2 | Validated |
| RMED-04 | Phase 8: Remediation Core | v1.2 | Validated |
| RMED-05 | Phase 8: Remediation Core | v1.2 | Validated |
| RMED-06 | Phase 8: Remediation Core | v1.2 | Validated |
| RMED-07 | Phase 8: Remediation Core | v1.2 | Validated |
| RMED-08 | Phase 8: Remediation Core | v1.2 | Validated |
| RMED-09 | Phase 8: Remediation Core | v1.2 | Validated |
| RMED-10 | Phase 8: Remediation Core | v1.2 | Validated |
| RMED-11 | Phase 9: Restore & Rollback | v1.2 | Validated |
| RMED-12 | Phase 9: Restore & Rollback | v1.2 | Validated |
| RMED-13 | Phase 9: Restore & Rollback | v1.2 | Validated |
| COMM-01 | Phase 10: Community Contribution | v1.2 | Out of Scope |
| COMM-02 | Phase 10: Community Contribution | v1.2 | Out of Scope |

**Coverage:**
- v1 requirements: 56 total
- Mapped to phases: 56
- Validated: 54 (phases 1–9 complete)
- Out of Scope: 2 (COMM-01, COMM-02 — deferred indefinitely)

---
*Requirements defined: 2026-04-03*
*Last updated: 2026-04-06 — all phases 1–9 validated; COMM-01/02 moved to Out of Scope*
