...
- [x] 05-04-framework-group-toggle-PLAN.md — Space on framework sub-header toggles group; outcome A (sub-headers rendered) vs B (D5-18 n/a) decided per codebase inspection
